                                ...
                                {atsScore && (
                                    <motion.div
                                        ...
                                        <div className='flex items-center justify-between'>
                                            <h4 className='font-bold text-gray-800'>ATS Score</h4>
                                            <div className={`text-3xl font-bold ${
                                                ...
                                                {atsScore.score} <span className='text-sm text-gray-600'>/ 100</span>
                                            </div>
                                        </div>
                                        ...
                                        {atsScore.strengths && atsScore.strengths.length > 0 && (
                                            <div>
                                                <p className='font-semibold text-gray-700 text-sm mb-2'>Strengths:</p>
                                        ...
                                        {/* Missing */}
                                        {atsScore.missing && atsScore.missing.length > 0 && (
                                            <div>
                                                <p className='font-semibold text-gray-700 text-sm mb-2'>Missing:</p>
                                                <ul className='space-y-1'>
                                                    {atsScore.missing.map((item, idx) => (
                                        ...
                                        {atsScore.suggestions && atsScore.suggestions.length > 0 && (
                                            <div>
                                                <p className='font-semibold text-gray-700 text-sm mb-2'>Suggestions:</p>
                                                <ul className='space-y-1'>
